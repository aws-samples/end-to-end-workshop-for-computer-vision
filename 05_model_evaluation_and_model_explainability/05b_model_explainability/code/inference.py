...
def handler(data, context):
    ...
    if context.request_content_type == 'image/jpeg':
        ...
        _return_error(415, 'Unsupported different content type "{}"'.format(context.request_content_type or 'Unknown'))
...
def _predict_using_grpc(context, instance):
    ...
    prediction_json = np.reshape (output_np, -1).tolist()
    print('this is what output predictions looks like ', np.reshape (output_np, -1).tolist() )
    print('this is what output predictions looks like ', prediction_json)
